...
def post_states_from_esp_frequently_only_registered_ips(newState: schemas.TemperatureHumidityCreate, db: Session = Depends(dependencies.get_db), device_is_registered: str = Depends(dependencies.get_current_request_ip)):
